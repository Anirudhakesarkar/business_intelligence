...
const navSections: NavSection[] = [
...

  {
    ...
    items: [
      ...
      { href: '/dashboard/school-management/ai-health', label: 'AI Health' },
      { href: '/dashboard/school-management/signals', label: 'Signals' },
      { href: '/dashboard/school-management/workers', label: 'Workers' },
