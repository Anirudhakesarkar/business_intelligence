...
export const MODULE_PAGE_HREFS: Record<ScoreModuleKey, string> = {
  ...
  occupancy: '/dashboard/school-intelligence/space-utilization',
  academic: '/dashboard/school-intelligence/teacher-productivity',
  staff: '/dashboard/school-intelligence/parent-experience',
  space: '/dashboard/school-intelligence/space-utilization',
  discipline: '/dashboard/school-intelligence/campus-safety',
